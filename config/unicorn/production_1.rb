...
listen "/tmp/unicorn_prod_1.sock", :backlog => 64
...
pid('/tmp/unicorn_production_1.pid')

# By default, the Unicorn logger will write to stderr.
# Additionally, ome applications/frameworks log to stderr or stdout,
# so prevent them from going to /dev/null when daemonized here:
stderr_path('/var/log/unicorn_production_1.stderr.log')
stdout_path('/var/log/unicorn_production_1.stdout.log')
